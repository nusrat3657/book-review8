const Review = () => {
    return (
        <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-200 text-gray-800 lg:ml-[340px] mt-10">
            <div className="flex flex-col items-center w-full">
                ...
                <div className="flex flex-col w-full">
                    ...
                    <button type="button" className="py-4 my-8 font-semibold rounded-md text-gray-50 bg-[#23BE0A]">Leave feedback</button>
                </div>
            </div>
